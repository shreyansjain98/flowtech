...
<body>
	<div class="nbcontainer">
		...
		<div class="menu nbpart">
			<ul class="menulist">
				...
				<li class="opt dd2">
					<span><i class="material-icons">business_center</i>Company<i class="material-icons">arrow_drop_down</i></span>
	...
	<div class="body2">
		...
		$sql1 = "SELECT prodid, prodcat, prodname, prodimg, linkadd FROM prodlist WHERE prodcat='PN'";
